...
<form:form method="POST" modelAttribute="cliente_b" id="cliente_b" type="cliente_b" action="modificarCliente_B" enctype="multipart/form-data">
	...
	<fieldset>
	  ...
	  <table>
		...
		<tr>
				...
				<td><form:input path="email_b" maxlength="15" id="email_b"  value= "${cliente_b.email_b}"/>
