...
public class Carro_BDaoImpl extends CustomHibernateDaoSupport implements Carro_BDao {
	...
	public void save(Carro_B carro_B) {
		...
		//getHibernateTemplate().save(carro_B);
                this.sessionFactory.getCurrentSession().save(carro_B);
	...
	public void update(Carro_B carro_B) {
		//getHibernateTemplate().update(carro_B);
                this.sessionFactory.getCurrentSession().update(carro_B);
	...
	public void delete(Carro_B carro_B) {
		//getHibernateTemplate().delete(carro_B);
                 this.sessionFactory.getCurrentSession().delete(carro_B);
	...
	public Carro_B findByCarro_BIdCarro_b(String carro_BIdCarro_b) {
		...
		return (Carro_B)list.get(0);
                */
                List <Carro_B> list = sessionFactory.getCurrentSession().createCriteria (Carro_B.class )
                        .add(Restrictions.eq("idcarro_b",Integer.parseInt(carro_BIdCarro_b)))
                        .list();
                return list.get(0);
	}
	...
	public List<Carro_B>findByTodosCarro_BIdCliente_b(String carro_BIdCliente_b) {
		...
		return list;
                */
              List <Carro_B> list = sessionFactory.getCurrentSession().createCriteria (Carro_B.class )
                        .add(Restrictions.eq("idcliente",Integer.parseInt(carro_BIdCliente_b)))
                        .list();
              return list;
	...
	public List<Carro_B> findAll(){
		...
		return list;
                */
                  return sessionFactory.getCurrentSession().createCriteria (Carro_B.class )
                                     .list();
